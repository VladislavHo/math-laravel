    ...
    public function checked(): void
    {
        ...
        if (isset($data['result']['status'])) {
            ...
            if (in_array($status, ['member', 'administrator', 'creator'])) {
                ...
                sleep(1);
                $text = 'Держите подробный разбор используемого нами метода, который позволяет повышать оценки с F до A, переходить в группу «задача со звездочкой», успешно сдавать экзамены по математике и физике, в конце концов поступать в лучшие университеты запада. Без пушинга!
