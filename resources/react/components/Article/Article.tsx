...
export default function Article() {
  const [checkStateTelegram, setCheckStateTelegram] = useState<boolean | null>(true);
  ...
  useEffect(() => {
    ...
    const getCheckTelegram = async () => {
      ...
      try {
        const telegramCheck = await checkTelegram(user_id ?? '')
        setCheckStateTelegram(telegramCheck.data)

      } catch (error) {
        setCheckStateTelegram(true)
      }
    }
  ...
  // console.log(checkStateTelegram.data);

  return (
    <section className='article'>
      {checkStateTelegram ? <div style={{
        display: 'flex',
