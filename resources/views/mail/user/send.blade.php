...
<body>
    ...
    <p>Спасибо на тестирование и консультацию в команду инновационного проекта MathHelp🤗, который позволяет гарантированно достигать академических целей на западе за счет использования научных знаний и инновационных AI решений.
    </p> <br>
